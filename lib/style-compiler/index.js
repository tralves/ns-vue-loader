...
module.exports = function (css, map) {
  ...
  if (!vueOptions) {
    if (query.hasInlineConfig) {
      this.emitError(
        `\n  [ns-vue-loader] It seems you are using HappyPack with inline postcss ` +
          `options for ns-vue-loader. This is not supported because loaders running ` +
  ...
  loadPostcssConfig(this, vueOptions.postcss)
    .then(config => {
      ...
      // add plugin for ns-vue-loader scoped css rewrite
      if (query.scoped) {
